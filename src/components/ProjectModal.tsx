...
interface ProjectModalProps {
  ...
  onClose: () => void
  onRequestEdit?: () => void
  onSubmitProject: (project: CreateProjectInput | UpdateProjectInput) => void | Promise<void>
}

const priorityOptions: ProjectPriority[] = ['urgent', 'high', 'medium', 'low']
const statusOptions: ProjectStatus[] = ['in-progress', 'review', 'blocked', 'done']
      ...
      <div className="modal-backdrop" role="presentation" onClick={onClose}>
        ...
        >
          ...
          <div className="modal-detail-grid">
            ...
            <div className="modal-detail">
              <span>Stack</span>
              <strong>{initialProject.stack.join(', ') || 'Non renseignée'}</strong>
            </div>
            <div className="modal-detail">
              <span>Priorité</span>
  ...
  return (
    <div className="modal-backdrop" role="presentation" onClick={onClose}>
      ...
      >
        <div className="modal-header">
          <div>
            <p className="eyebrow">{mode === 'create' ? 'Nouveau projet' : 'Édition projet'}</p>
