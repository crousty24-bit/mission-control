...
export interface MissionControlDataSource {
  ...
  updateProject: (projectId: string, input: UpdateProjectInput) => Promise<ProjectWithProgress>
  ...
  updateAgent: (agentId: string, input: UpdateAgentInput) => Promise<LocalAgent>
